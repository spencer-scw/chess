...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_LIGHT_GREY = SET_TEXT_COLOR + "239m";
    public static final String SET_TEXT_COLOR_DARK_GREY = SET_TEXT_COLOR + "234m";
    ...
    public static final String SET_TEXT_COLOR_CREAM = SET_TEXT_COLOR + "215m";
    public static final String SET_TEXT_COLOR_WHITE = SET_TEXT_COLOR + "15m";
    public static final String RESET_TEXT_COLOR = "\033[39m";

    public static final String SET_BG_COLOR_BLACK = SET_BG_COLOR + "0m";
    public static final String SET_BG_COLOR_LIGHT_GREY = SET_BG_COLOR + "246m";
    public static final String SET_BG_COLOR_GREY = SET_BG_COLOR + "240m";
    ...
    public static final String SET_BG_COLOR_BLUE = SET_BG_COLOR + "39m";
    public static final String SET_BG_COLOR_MAGENTA = SET_BG_COLOR + "5m";
    public static final String SET_BG_COLOR_WHITE = SET_BG_COLOR + "15m";
    public static final String RESET_BG_COLOR = "\033[49m";
